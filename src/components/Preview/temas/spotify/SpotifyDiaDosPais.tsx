...
import ComentariosAnderson from "./componentes/ComentariosAnderson";
import PlayerAnderson from "./componentes/PlayerAnderson";

type SpotifyTemaProps = {
    model: ISpotifyAniversario
}

function SpotifyDiaDosPais({ model }: SpotifyTemaProps) {
        ...
        <div className={`${backgroundsPage[0]} text-white min-h-screen pb-[130px] p-4`}>
            <div className="flex flex-col gap-12">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">Feliz Dia dos Pais!</h1>
...
export default SpotifyDiaDosPais;